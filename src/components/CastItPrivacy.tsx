            ...
            <Col md={12}>
                <div id="myexpenses_privacy_div">
                    <div className="text-left">
                        ...
                        <p>Effective date: April 27, 2022</p>

                        <p>CastIt ("us", "we", or "our") operates the CastIt mobile application (the "Service").</p>

                        <p>
                            This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
                            use our Service and the choices you have associated with that data. Our Privacy Policy for CastIt is
                        ...
                        <p>CastIt uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>
                            CastIt will take all steps reasonably necessary to ensure that your data is treated securely and in
                        ...
                        <p>CastIt may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of CastIt</li>
                        ...
                        <ul>
                            ...
                            <li>By visiting this page on our website: https://github.com/Wolfteam/CastIt</li>
                        </ul>
                    </div>
                </div>
            </Col>
