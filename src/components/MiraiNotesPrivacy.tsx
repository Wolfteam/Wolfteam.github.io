...
function MiraiNotesPrivacy() {
    return <Row>
        <Col md={12}>
            <div id="mirainotes_privacy_div">
                <div className="text-left">
                    <h1>Privacy Policy</h1>

                    <p>Effective date: December 03, 2019</p>

                    <p>Mirai Notes ("us", "we", or "our") operates the Mirai Notes mobile application (the
                    "Service").</p>

                    <p>This page informs you of our policies regarding the collection, use, and disclosure of
                    personal
                    data when you use our Service and the choices you have associated with that data. Our
                    Privacy
                    Policy for Mirai Notes is created with the help of the <a
                    ...
                    <ul>
                        <li>Email address</li>
                        <li>First name, last name, profile image</li>
                        <li>Access to your tasks and task lists</li>
                    </ul>
                    ...
                    <p>Mirai Notes uses the collected data for various purposes:</p>
                    <ul>
                    ...
                    <p>If you are located outside Ecuador and choose to provide information to us, please note
                    that
                    we
                    transfer the data, including Personal Data, to Ecuador and process it there.</p>
                    <p>Your consent to this Privacy Policy followed by your submission of such information
                    represents
                    your agreement to that transfer.</p>
                    <p>Mirai Notes will take all steps reasonably necessary to ensure that your data is treated
                    securely
                    and in accordance with this Privacy Policy and no transfer of your Personal Data will
                    take
                    place
                    to an organization or a country unless there are adequate controls in place including
                    the
                    ...
                    <p>Mirai Notes may disclose your Personal Data in the good faith belief that such action is
                    necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of Mirai Notes</li>
                    ...
                    <ul>
                        ...
                        <li>By visiting this page on our website: https://github.com/Wolfteam/MiraiNotes</li>
...
export default MiraiNotesPrivacy;