        ...
        <Col md={12}>
            <div id="myexpenses_privacy_div">
                <div className="text-left">
                    ...
                    <p>Effective date: May 05, 2020</p>

                    <p>My Expenses ("us", "we", or "our") operates the My Expenses mobile application (the
                    "Service").
                </p>
                    ...
                    Privacy
                    Policy for My Expenses is created with the help of the <a
                    ...
                    <p>My Expenses uses the collected data for various purposes:</p>
                    <ul>
                    ...
                    <p>My Expenses will take all steps reasonably necessary to ensure that your data is treated
                    securely
                    ...
                    <p>My Expenses may disclose your Personal Data in the good faith belief that such action is
                    necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of My Expenses</li>
...
export default MyExpensesPrivacy;