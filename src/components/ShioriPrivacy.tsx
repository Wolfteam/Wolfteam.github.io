...
function ShioriPrivacy() {
    return (
        <Row>
            <Col md={12}>
                <div id="myexpenses_privacy_div">
                    <div className="text-left">
                        <h1>Privacy Policy</h1>

                        <p>Effective date: November 05, 2021</p>

                        <p>Shiori for Genshin ("us", "we", or "our") operates the Shiori for Genshin mobile application (the "Service").</p>

                        <p>
                            This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
                            use our Service and the choices you have associated with that data. Our Privacy Policy for Shiori for Genshin is
                        ...
                        <p>Shiori for Genshin uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>
                            If you are located outside Ecuador and choose to provide information to us, please note that we transfer the
                            data, including Personal Data, to Ecuador and process it there.
                        </p>
                        <p>
                        ...
                        <p>
                            Shiori for Genshin will take all steps reasonably necessary to ensure that your data is treated securely and in
                        ...
                        <p>Shiori for Genshin may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Shiori for Genshin</li>
                        ...
                        <ul>
                            ...
                            <li>By visiting this page on our website: https://github.com/Wolfteam/Shiori</li>
                        </ul>
                    </div>
                </div>
            </Col>
